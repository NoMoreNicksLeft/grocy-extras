...
# Storage: These circular pdfs seem to weigh in at 1 meg each. Prepare 5m/month 
# (60 megs per year) for archiving.

################################################################################
#################################### main() ####################################
################################################################################

r = requests.get(f"https://dam.flippenterprise.net/flyerkit/publications/ffheb?locale=en&access_token=98856c1ed32273db1aac58bfe8c76d90&show_storefronts=true&store_code={store}")
...
for c in filtered:
    ...
    pdf = f"{file_location}HEB Circular - {date}.pdf"
