...
r = requests.get(f"https://dam.flippenterprise.net/flyerkit/publications/homedepotusa?locale=en&access_token=4c1ca51353684ca4e164176a2363d7bf&show_storefronts=true&store_code={store}")
...
for c in filtered:
    ...
    pdf = f"{file_location}Home Depot Circular - {date}.pdf"
